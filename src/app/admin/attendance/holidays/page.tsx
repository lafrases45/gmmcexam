...
export default function HolidaySetupPage() {
  ...
  const handleAddHoliday = async () => {
    try {
      ...
      alert('Error adding holiday: ' + e.message);
    }
  };
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input type="number" className="w-full bg-slate-50 border-slate-100 border-2 p-4 rounded-2xl outline-none font-bold" value={bsYear} onChange={e => setBsYear(parseInt(e.target.value))} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="number" className="w-full bg-slate-50 border-slate-100 border-2 p-4 rounded-2xl outline-none font-bold" value={bsDay} onChange={e => setBsDay(parseInt(e.target.value))} />
                </div>
              </div>
              ...
              <div className="flex gap-4 pt-6">
                ...
                <button className="flex-1 py-4 rounded-2xl font-black text-slate-500 hover:bg-slate-100 transition-all" onClick={() => setShowAddModal(false)}>
                  Cancel
                </button>
              </div>
            </div>
